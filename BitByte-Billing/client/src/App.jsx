  ...
  return (
    <Routes>
      ...
      <Route element={<RoleLayout role="Accountant" />}>
        ...
        <Route path="/accountant/pricing/:quotationId" element={<PricingPage />} />
        <Route path="/accountant/clarifications" element={<TablePage type="quotations" role="Accountant" filterStatus="Needs Clarification" />} />
      ...
      <Route element={<RoleLayout role="Admin" />}>
        ...
        <Route path="/admin/invoices/generate/:quotationId" element={<InvoiceGeneration />} />
